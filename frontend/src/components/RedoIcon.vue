...
<template>
  <svg :width="`${props.width ?? 50}px`" :height="`${props.height ?? 50}px`" fill="#000000" version="1.1" id="Capa_1" viewBox="0 0 40.5 40.5" xml:space="preserve">
    <g>
      <path
        d="M39.622,21.746l-6.749,6.75c-0.562,0.562-1.326,0.879-2.122,0.879s-1.56-0.316-2.121-0.879l-6.75-6.75
